            ...
            messages: [
                {
                    ...
                    from: {
                        ...
                        photo: {
                            url: b ? await hisoka.getProfilePict(m.sender).catch(() => 'https://i0.wp.com/telegra.ph/file/134ccbbd0dfc434a910ab.png') : await hisoka.getProfilePict(quoted.sender).catch(() => 'https://i0.wp.com/telegra.ph/file/134ccbbd0dfc434a910ab.png'),
                        }
                    },
                    ...media,
